...
```javascript
import Vue from 'vue';
import ElementUI from 'auto-element';
import 'auto-element/lib/theme-chalk/index.css';
...
```javascript
import Vue from 'vue';
import { Button, Select } from 'auto-element';
import App from './App.vue';
...
```js
import Vue from 'vue';
import { Button } from 'auto-element';
