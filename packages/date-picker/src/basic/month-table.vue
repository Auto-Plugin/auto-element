...
<script type="text/babel">
  ...
  import { isDate, range, getDayCountOfMonth, nextDate } from 'auto-element/src/utils/date-util';
  import { hasClass } from 'auto-element/src/utils/dom';
  import { arrayFindIndex, coerceTruthyValueToArray, arrayFind } from 'auto-element/src/utils/util';
