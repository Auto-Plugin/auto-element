...
<script type="text/babel">
  ...
  import { isDate, range, nextDate, getDayCountOfYear } from 'auto-element/src/utils/date-util';
  import { arrayFindIndex, coerceTruthyValueToArray } from 'auto-element/src/utils/util';
