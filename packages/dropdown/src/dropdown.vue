<script>
  ...
  import ElButton from 'auto-element/packages/button';
  import ElButtonGroup from 'auto-element/packages/button-group';
  import { generateId } from 'auto-element/src/utils/util';
